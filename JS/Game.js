//Variaveis Globais
var Cenario, sala, ResultAjax, ResultAjaxHeritage;
...
ws.onopen = function(e) {console.log("Conexão estabelecida");};
...
//Seleciona a sala
function Room(){
	sala = document.getElementById("Room").value;
	if( (sala != 0) && (sala != -1) ) {
		...
		document.getElementById("PlayerOnline").style.visibility = "visible";
		...
		document.getElementById("PlayerOnline").style.visibility = "hidden";
		quantidadeJogadores = 4;
		}
}

function Player_Online(){
	var P_O = document.getElementById("PlayerOnline").value;
	if(P_O == 2){
		quantidadeJogadores = 2;
	} else if (P_O == 3) {
...
function Iniciar(){
	...
	switch(quantidadeJogadores){
		case 2:
		//Checar o modo de jogo escolhido (local ou online)
		if( (sala != undefined) && (sala != 0) && (sala != -1)){
			//checar se todos os campos estão preenchidos
			if((Cenario.length == 0) || (P1.length == 0)){ 
				alert("Preencha todos os campos antes de iniciar.");
			} else {
				//Checar se existe o cenário e se alguma partida já iniciou
				//-------------------------------------------------------------------------------------------------------------------------
				$.post( "https://trosleihard.000webhostapp.com/TCP/SelectOnlineGame.php", { Code_Room: Cenario} )
					.done(function( data ) {
					ResultAjax = JSON.parse(data);
					ResultAjaxOnline[0] = ResultAjax[0];
					ResultAjaxOnline[1] = ResultAjax[1];
					if((ResultAjaxOnline[0] != Cenario)){
						alert("Cenário inexistente em nosso banco de dados.");
					} else{
						if (ResultAjaxOnline[1] != 0) {
							alert("Esta sala já iniciou sua partida. Aguarde até que a rodada termine ou escolha por outra partida.");
						} else {
							AjaxInicial();
						}
					}
			...
			if( ((Cenario.length == 0) || (P1.length == 0) || (P2.length == 0) || (sala == undefined)) && (sala == 0)){
				...
				//Checar a sala escolhida
				 if (sala == -1){ alert("Escolha uma sala válida.");}else {
	...
	//-------------------------------------------------------------------------------------------------------------------------
		...
		case 3:
			...
			if((Cenario.length == 0) || (P1.length == 0) || (P2.length == 0) || (P3.length == 0) || (sala == undefined)){
				...
				//Checar a sala escolhida
				if((sala != 0) && (sala != -1)) { alert("Sala indisponivel."); } else if (sala == -1){ alert("Escolha uma sala.");}else {
					//Chegar se existe nomes iguais
	...
	//-------------------------------------------------------------------------------------------------------------------------
			...
			break;
		default:
			alert("Erro na quantidade de jogadores!");
			break;
	}	
}
...
$.post( "https://trosleihard.000webhostapp.com/TCP/SelectAllHeritage.php", { Code_Room: Cenario} )
	...
	Answer_Question[11][0] = ResultAjaxHeritage[111];
...
function Question(PosX, PosY){
		RandomQuestion = Math.floor((Math.random()*15) + 1);
		...
		if((PosX == posicao[1][0] && PosY == posicao[1][1])){
			...
			NumPatrimonio = 0; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 2
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 1; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 3
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 2; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 4
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 3; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 5
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 4; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 6
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 5; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 7
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 6; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 8
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 7; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 9
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 8; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 10
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 9; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 11
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 10; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 12
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 11; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 13
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 12; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 14
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 13; // Variavel para saber qual patrimonio será pedido
		}
		//Patrimônio 15
			...
			$("#patrimonioImg").attr("src", "data:image/jpge;base64," + Image_Heritage[RandomQuestion]);
			$("#patrimonioName").text("Nome do Patrimônio - " + Nick_Heritage[RandomQuestion]);
			NumPatrimonio = 14; // Variavel para saber qual patrimonio será pedido
		}
}
	...
	if(Answer == Answer_Question[NumPatrimonio][0]){
		...
		switch(TimePlayer){
			case 1:
				...
				document.getElementById("PontosJogadorVerde").innerHTML = One.Score.toFixed(2);
				break;
			case 2:
				Two.Score += PtsQuestion;
				document.getElementById("PontosJogadorVermelho").innerHTML = Two.Score.toFixed(2);
				break;
			case 3:
				Three.Score += PtsQuestion;
				document.getElementById("PontosJogadorAzul").innerHTML = Three.Score.toFixed(2);
				break;
			case 4:
				Four.Score += PtsQuestion;
				document.getElementById("PontosJogadorAmarelo").innerHTML = Four.Score.toFixed(2);
				break;
		}
		...
		switch(EscolhaDoUsuario){
			...
			document.getElementById("R1").style.backgroundColor= "Red";
				setTimeout(function(){document.getElementById("R1").style.backgroundColor= "#00cec9";document.getElementById("perguntas").style.visibility = "hidden";AmountPlayer();IluminarNome(TimePlayer); document.getElementById("Dice").disabled = false;}, 1000);
				break;
			case 1:
				document.getElementById("R2").style.backgroundColor= "Red";
				setTimeout(function(){document.getElementById("R2").style.backgroundColor= "#00cec9";document.getElementById("perguntas").style.visibility = "hidden";AmountPlayer();IluminarNome(TimePlayer); document.getElementById("Dice").disabled = false;}, 1000);
				break;
			case 2:
				document.getElementById("R3").style.backgroundColor= "Red";
				setTimeout(function(){document.getElementById("R3").style.backgroundColor= "#00cec9";document.getElementById("perguntas").style.visibility = "hidden";AmountPlayer();IluminarNome(TimePlayer); document.getElementById("Dice").disabled = false;}, 1000);
				break;
			case 3:
				document.getElementById("R4").style.backgroundColor= "Red";
				setTimeout(function(){document.getElementById("R4").style.backgroundColor= "#00cec9"; document.getElementById("perguntas").style.visibility = "hidden";AmountPlayer();IluminarNome(TimePlayer); document.getElementById("Dice").disabled = false;}, 1000);
				break;
			default:
				alert("Erro na escolha da resposta!");
				break;
...
function EndFunction(){
	document.getElementById('winSound').play();
		...
		if( ((One.Score == Two.Score) && (quantidadeJogadores==2)) || ((One.Score == Two.Score) && (quantidadeJogadores == 3)) || ((One.Score == Two.Score) && (quantidadeJogadores==4)) || ((One.Score == Three.Score) && (quantidadeJogadores == 3)) || ((One.Score == Three.Score) && (quantidadeJogadores == 4)) || ((One.Score == Four.Score) && (quantidadeJogadores == 4)) || ((Three.Score == Two.Score) && (quantidadeJogadores == 3)) || ((Three.Score == Two.Score) && (quantidadeJogadores == 4)) || ((Four.Score == Two.Score) && (quantidadeJogadores == 4)) || ((Three.Score == Four.Score) && (quantidadeJogadores == 4)) ){
...
function JogadorInicial(jogadorVez){
	document.getElementById("vezText").innerHTML=jogadorVez;
	document.getElementById("vez").style.visibility="visible";
	setTimeout(function(){document.getElementById("vez").style.visibility="hidden";}, 5000);
}
